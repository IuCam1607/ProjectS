...
public class CombatStanceState : State
{
    ...
    public override State Tick(EnemyManager enemy)
    {
        ...
        if (!randomDestinationSet)
        {
            ...
            DecideCirlingAction(enemy.enemyAnimator);
        }
    ...
    protected void DecideCirlingAction(EnemyAnimatorManager enemyAnimator)
    {

        WalkAroundTarget(enemyAnimator);
    }

    protected void WalkAroundTarget(EnemyAnimatorManager enemyAnimator)
    {
